-- Optional seed data for ReelRamp Pro.
...
('Aakhri Message','A premium emotional thriller episode.','Raat Ki Awaaz',1,'your-premium-file.mp4','https://images.pexels.com/photos/7709297/pexels-photo-7709297.jpeg?auto=compress&cs=tinysrgb&w=1200',true,true,140,'Thriller','U/A 16+')
on conflict do nothing;
...
insert into notifications (title,message,target,is_active) values ('Welcome to ReelRamp Pro','New stories, premium episodes and subscription offers will appear here.','all',true) on conflict do nothing;

insert into legal_policies (title,type,version,is_published,body) values
('Privacy Policy','privacy','2026.1',true,'Effective from 2026. ReelRamp Pro collects only essential account, playback, subscription and support information needed to operate the service.'),
('Terms, Refunds & Content Policy','terms','2026.1',true,'ReelRamp Pro is operated by ReelRamp Originals Pvt. Ltd. Users must not redistribute paid content. Refunds and cancellations follow company and payment gateway policy.'),
...
('Video not playing?','Check your internet, confirm the Bunny.net filename is correct in admin, and tap Retry on the player.','Video',true,1),
('How subscription works','Plans unlock premium ReelRamp stories. Razorpay/live gateway can be connected when your payment account is ready.','Plans',true,2),
