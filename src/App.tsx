      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-[#222] grid md:grid-cols-4 gap-y-10 text-sm">
          ...
          <div>
            ...
            <div className="text-xs leading-snug">FF Shop No. 6, Arohi Arcade, Munshipulia, Lucknow - 226016</div>
...
// SIMPLIFIED ADMIN PAGE - Add this complete component
function AdminPage() {
  const navigate = useNavigate();
